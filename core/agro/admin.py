...
from .models import CostoProd, CostoProdo, Producto, agro_Etapa, Lote, Planificacion_etapas
from .models import Apli_costo_etapa, Comprobantes
...
admin.site.register(Apli_costo_etapa)
